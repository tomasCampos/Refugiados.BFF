...
namespace Repositorio.Repositorios.Interfaces
{
    public interface IEmpresaRepositorio
    {
        ...
        public Task AtualizarEmpresa(string razaoSocial, int codigoUsuario, string cnpj, string nomeFantasia, DateTime? dataFundacao, int? numeroFuncionarios, int? codigoEndereco);
    }
}
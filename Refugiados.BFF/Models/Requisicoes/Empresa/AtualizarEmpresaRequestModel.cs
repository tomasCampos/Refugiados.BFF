...
namespace Refugiados.BFF.Models.Requisicoes.Empresa
{
    public class AtualizarEmpresaRequestModel : IRequestModel
    {
        ...
        public ValidacaoRequisicaoModel Validar()
        {
            ...
            if (string.IsNullOrWhiteSpace(RazaoSocial) && string.IsNullOrWhiteSpace(CNPJ) && string.IsNullOrWhiteSpace(NomeFantasia) && !DataFundacao.HasValue && !NumeroFuncionarios.HasValue)

...
namespace Refugiados.BFF.Servicos
{
    public class UsuarioServico : IUsuarioServico
    {
        ...
        public async Task<CadastrarAtualizarUsuarioServiceModel> CadastrarUsuario(string emailUsuario, string senhaUsuario, string telefoneUsuario, int? perfilUsuario = null)
        {
            ...
            await _usuarioRepositorio.CadastrarUsuario(emailUsuario, senhaCifrada, telefoneUsuario, perfilUsuario);
        ...
        public async Task<CadastrarAtualizarUsuarioServiceModel> CadastrarUsuarioColaborador(string emailUsuario, string senhaUsuario, string telefoneUsuario, ColaboradorModel colaborador) 
        {
            var resultadoCadastroUsuario = await CadastrarUsuario(emailUsuario, senhaUsuario, telefoneUsuario, (int)PerfilUsuario.Colaborador);
        ...
        public async Task<CadastrarAtualizarUsuarioServiceModel> AtualizarUsuario(string emailUsuario, string senhaUsuario, bool? entrevistado, string telfoneUsuario, int codigoUsuario)
        {
            ...
            if (usuarioAtual != null)
            {
                ...
                usuarioAtual.TelefoneUsuario = !string.IsNullOrEmpty(telfoneUsuario) ? telfoneUsuario : usuarioAtual.TelefoneUsuario;
                usuarioAtual.Entrevistado = entrevistado.HasValue ? entrevistado.Value : usuarioAtual.Entrevistado;
                await _usuarioRepositorio.AtualizarUsuario(usuarioAtual.EmailUsuario, usuarioAtual.SenhaUsuario, usuarioAtual.Entrevistado, usuarioAtual.TelefoneUsuario, codigoUsuario);                         
            }
